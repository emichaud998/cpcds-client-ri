...
class DashboardController < ApplicationController
  ...
  def launch
    ...
    reset_session
    cookies.clear
    unless all_credentials_provided?
      redirect_to home_path,
                  alert: 'Please provide the server_url, client_id, and client_secret.' and return
    end
    ...
    if session[:is_auth_server?]
      begin
        ...
        redirect_back fallback_location: home_path, alert: "Failed to connect: #{e.message}" and return
      end
